...
INSERT INTO sedes (id, codigo, nombre, descripcion, usuario_id, fecha_borrado) 
	VALUES (1, 1, 'Rafael Osinalde', 'Cancha de futball', 3,null);
    
INSERT INTO sedes (id, codigo, nombre, descripcion, usuario_id, fecha_borrado)
	VALUES (2, 2, 'Gregorio Panizza', 'Cancha de basquet', 3,null);
    
INSERT INTO sedes (id, codigo, nombre, descripcion, usuario_id, fecha_borrado)
	VALUES (3, 3, 'Club Talense', 'Cancha de tenis', 3,null);

INSERT INTO sedes (id, codigo, nombre, descripcion, usuario_id, fecha_borrado) 
	VALUES (4, 4, '2 de Enero', 'Cancha de futball', 3,null);
